  ...
  async createOrder(
    ...
    try {
      ...
      for (const item of items) {
        //can't return from forEach. --> for of loop
  ...
  async getOrder(
    ...
    try {
      ...
      if (
        ...
        order.driverId !== user.id && //customer, driver: relationId from entity
        order.restaurant.ownerId !== user.id //owner: load restaurant relations
      ) {
        return {
          ok: false,
          error: 'Access denied.',
